...
const TerminalComponent = () => {
  useEffect(() => {
    ...
    //   const time = new Date(Date.now())
    //   term.writeln(
    //     '\r\n' + '@oizys18 [' + time.getHours() + ':' + time.getMinutes() + ']'
    //   )
    //   term.write('\x1b[1;93m$ \x1b[0m')
    // }
    // term.help = () => {
    //   term.writeln('')
    //   term.writeln('~~~ 명령어 일람 ~~~')
    ...
    // let cmd = ''
    // term.onKey(data => {
    //   const input = data.key.charCodeAt(0)
    //   if (input === 13) {
    //     if (cmd === 'clear') {
    //       term.writeln('')
    //       term.clear()
    ...
    //   } else if (input === 27) {
    //     console.log('esc')
    //   } else if (input === 127 && cmd.length > 0) {
    //     if (cmd.length > 0) {
    //       term.write('\b \b')
    //       cmd = cmd.slice(0, -1)
    //       // why does this code keep making errors?
    //     } else {
    //       console.log(data)
    //     }
    //     // console.log(cmd, cmd.length)
    //     return
    //   } else if (input === 37 || input === 39 || input === 16) {
    //     return
    //   } else {
    //     cmd += data.key
    //     term.write(data.key)
